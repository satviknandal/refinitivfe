...
@Component({
  selector: 'app-nodetreemock-chart',
  templateUrl: './nodetreemock-chart.component.html',
  styleUrls: ['./nodetreemock-chart.component.scss']
})
export class NodeTreeMockChartComponent  implements OnInit {
  constructor() {}
 ...
 draw() {
    ...
    const container = document.getElementById('mockchart');
    const data = {
      nodes: nodes,
      edges: edges
    };
